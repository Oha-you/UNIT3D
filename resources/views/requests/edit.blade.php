                ...
                <form class="form" method="POST"
                        ...
                        <div class="form__group--vertical"
                            ...
                            <p class="form__group">
                                <input type="checkbox" class="form__checkbox"
                                    ...
                                    value="1" x-model="imdb_title_exists" />
                        ...
                        <div class="form__group--vertical"
                            ...
                            <p class="form__group">
                                <input type="checkbox" class="form__checkbox"
                                    ...
                                    value="1" x-model:checked="mal_anime_exists" />
                        ...
                        <div class="form__group--vertical" x-show="cats[cat].type === 'game'">
                            <p class="form__group">
                                <input type="checkbox" class="form__checkbox"
                                    ...
                                    value="1" x-model="igdb_game_exists" />
                    ...
                    <p class="form__group">
                        ...
                        <input type="checkbox" class="form__checkbox" id="anon" name="anon"
                            value="1" @checked($torrentRequest->anon) />
