        ...
        <section class="panelV2" x-data="requestCreate">
            ...
            <div class="panel__body">
                <form class="form" method="POST" action="{{ route('requests.store') }}">
                    @csrf
                    <p class="form__group">
                        <input id="title" class="form__text" name="name" required type="text"
                    ...
                    <p class="form__group">
                        <select name="category_id" id="category_id" class="form__select" required
                            x-model="cat"
                    ...
                    <div class="form__group--horizontal"
                        ...
                        <div class="form__group--vertical" x-show="cats[cat].type === 'tv'">
                            <p class="form__group">
                                <input type="checkbox" class="form__checkbox" id="tv_exists_on_tmdb"
                                    name="tv_exists_on_tmdb" value="1"
                                    @checked(old('tv_exists_on_tmdb', true)) x-model="tmdb_tv_exists" />
                            ...
                            <p class="form__group" x-show="tmdb_tv_exists">
                                ...
                                <input id="tmdb_tv_id" class="form__text" inputmode="numeric"
                                    name="tmdb_tv_id" pattern="[0-9]*" placeholder=" "
                                    type="text"
                        ...
                        <div class="form__group--vertical"
                            ...
                            <p class="form__group">
                                <input type="checkbox" class="form__checkbox"
                                    id="title_exists_on_imdb" name="title_exists_on_imdb"
                                    value="1" @checked(old('title_exists_on_imdb', true))
                            ...
                            <p class="form__group" x-show="imdb_title_exists">
                                ...
                                <input id="autoimdb" class="form__text" inputmode="numeric"
                        ...
                        <div class="form__group--vertical" x-show="cats[cat].type === 'tv'">
                            <p class="form__group">
                                <input type="checkbox" class="form__checkbox" id="tv_exists_on_tvdb"
                                    name="tv_exists_on_tvdb" value="1"
                                    @checked(old('tv_exists_on_tvdb', true)) x-model="tvdb_tv_exists" />
                            ...
                            <p class="form__group" x-show="tvdb_tv_exists">
                                ...
                                <input id="autotvdb" class="form__text" inputmode="numeric"
                        ...
                        <div class="form__group--vertical"
                            ...
                            <p class="form__group">
                                <input type="checkbox" class="form__checkbox"
                                    id="anime_exists_on_mal" name="anime_exists_on_mal"
                                    value="1" @checked(old('anime_exists_on_mal', true))
                            ...
                            <p class="form__group" x-show="mal_anime_exists">
                                ...
                                <input id="automal" class="form__text" inputmode="numeric"
                        ...
                        <div class="form__group--vertical" x-show="cats[cat].type === 'game'">
                            <p class="form__group">
                                <input type="checkbox" class="form__checkbox"
                                    id="game_exists_on_igdb" name="game_exists_on_igdb"
                                    value="1" @checked(old('game_exists_on_igdb', true))
                            ...
                            <p class="form__group" x-show="igdb_game_exists">
                                <input id="igdb" class="form__text" inputmode="numeric"
                                    name="igdb" pattern="[0-9]*" placeholder=" " type="text"
                    ...
                    <p class="form__group">
                        <input id="bounty" class="form__text" name="bounty" type="text"
                            pattern="[0-9]*?[1-9][0-9]{2,}" value="100" required />
