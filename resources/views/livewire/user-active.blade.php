    ...
    <section class="panelV2 user-peers__filters">
        ...
        <div class="panel__body">
            <form class="form">
                ...
                <p class="form__group">
                    <label style="user-select: none" class="form__label" x-data="ternaryCheckMark($wire.entangle('seeding').live)">
                        <input type="checkbox" class="user-peers__checkbox" x-bind="input" />
                        {{ __('torrent.seeding') }}
                    </label>
                </p>
                <p class="form__group">
                    <label style="user-select: none" class="form__label" x-data="ternaryCheckMark($wire.entangle('active').live)">
                        <input type="checkbox" class="user-peers__checkbox" x-bind="input" />
                        {{ __('common.active') }}
                    </label>
                </p>
                <p class="form__group">
                    <label style="user-select: none" class="form__label" x-data="ternaryCheckMark($wire.entangle('visible').live)">
                        <input type="checkbox" class="user-peers__checkbox" x-bind="input" />
                        Visible
                    </label>
                </p>
                <p class="form__group">
                    <label class="form__label">
                        <input type="checkbox" class="user-peers__checkbox"
    ...
    <section class="panelV2 user-peers">
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                <thead>
                    <th class="user-active__name-header" wire:click="sortBy('name')"
                        role="columnheader button">
                        {{ __('torrent.name') }}
                        @include('livewire.includes._sort-icon', ['field' => 'name'])
                    </th>
                    <th class="user-active__seeders-header" wire:click="sortBy('seeders')"
                    ...
                    <th class="user-active__leechers-header" wire:click="sortBy('leechers')"
                    ...
                    <th class="user-active__times-header" wire:click="sortBy('times_completed')"
                    ...
                    <th class="user-active__agent-header" wire:click="sortBy('agent')"
                        role="columnheader button">
                        {{ __('torrent.client') }}
                        @include('livewire.includes._sort-icon', ['field' => 'agent'])
                    </th>
                    <th class="user-active__ip-header" wire:click="sortBy('ip')"
                        role="columnheader button">
                        {{ __('common.ip') }}
                        @include('livewire.includes._sort-icon', ['field' => 'ip'])
                    </th>
                    <th class="user-active__port-header" wire:click="sortBy('port')"
                        role="columnheader button">
                        {{ __('common.port') }}
                    ...
                    <th class="user-active__visible-header" wire:click="sortBy('visible')"
                        role="columnheader button" title="Visible">
                        <i class="{{ config('other.font-awesome') }} fa-eye"></i>
                        @include('livewire.includes._sort-icon', [
                            'field' => 'visible',
                        ])
                    </th>
                    <th class="user-active__size-header" wire:click="sortBy('size')"
                        role="columnheader button">
                        {{ __('torrent.size') }}
                        @include('livewire.includes._sort-icon', ['field' => 'size'])
                    </th>
                    <th class="user-active__uploaded-header" wire:click="sortBy('uploaded')"
                        role="columnheader button">
                        {{ __('torrent.uploaded') }}
                        @include('livewire.includes._sort-icon', [
                            'field' => 'uploaded',
                    ...
                    <th class="user-active__downloaded-header" wire:click="sortBy('downloaded')"
                        role="columnheader button">
                    ...
                    <th class="user-active__left-header" wire:click="sortBy('left')"
                        role="columnheader button">
                        {{ __('torrent.left') }}
                        @include('livewire.includes._sort-icon', ['field' => 'left'])
                    </th>
                    <th class="user-active__progress-header" wire:click="sortBy('progress')"
                        role="columnheader button">
                        {{ __('torrent.progress') }}
                        @include('livewire.includes._sort-icon', [
                            'field' => 'progress',
                    ...
                    <th class="user-active__created-at-header" wire:click="sortBy('created_at')"
                        role="columnheader button">
                        {{ __('torrent.started') }}
                        @include('livewire.includes._sort-icon', [
                            'field' => 'created_at',
                    ...
                    <th class="user-active__updated-at-header" wire:click="sortBy('updated_at')"
                        role="columnheader button">
                        {{ __('torrent.updated') }}
                        @include('livewire.includes._sort-icon', [
                            'field' => 'updated_at',
                    ...
                    @foreach ($actives as $active)
                        <tr>
                            ...
                            <td @class([
                                ...
                                @if ($active->seeding) title="{{ __('torrent.currently-seeding') }}" @endif>
                            ...
                            <td @class([
                                ...
                                @if ($active->leeching) title="{{ __('torrent.currently-leeching') }}" @endif>
                                    ...
                                    @else
                                        @if ($connectable)
                                            <i class="{{ config('other.font-awesome') }} text-green fa-wifi"
                                                title="Connectable"></i>
                                        @else
                                            <i class="{{ config('other.font-awesome') }} text-red fa-wifi-slash"
                            ...
                            <td
                                ...
                                @if ($active->visible)
                                    <i class="{{ config('other.font-awesome') }} text-green fa-eye"
                                        title="Visible"></i>
                                @else
                                    <i class="{{ config('other.font-awesome') }} text-red fa-eye-slash"
                                        title="Invisible"></i>
                                @endif
                            </td>
                            ...
                            <td class="user-active__progress"
