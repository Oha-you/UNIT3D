        ...
        <div class="panel__body" style="padding: 5px">
            <form class="form">
                <div class="form__group--short-horizontal">
                    <p class="form__group">
                        <input id="username" class="form__text" type="text"
                    ...
                    <p class="form__group">
                        <input id="soundexUsername" class="form__text" type="text"
                            wire:model.live="soundexUsername" placeholder=" " />
                        <label class="form__label form__label--floating" for="soundexUsername">
                            Soundex {{ __('common.username') }}
                        </label>
                    </p>
                    <p class="form__group">
                        <input id="email" class="form__text" type="text"
                    ...
                    <p class="form__group">
                        <input id="soundexEmail" class="form__text" type="text"
                    ...
                    <p class="form__group">
                        <input id="apikey" class="form__text" type="text"
                            wire:model.live="apikey" placeholder=" " />
                        <label class="form__label form__label--floating" for="apikey">
                            {{ __('user.apikey') }}
                        </label>
                    </p>
                    <p class="form__group">
                        <input id="rsskey" class="form__text" type="text"
                            wire:model.live="rsskey" placeholder=" " />
                        <label class="form__label form__label--floating" for="rsskey">
                            {{ __('user.rsskey') }}
                        </label>
                    </p>
                    <p class="form__group">
                        <input id="passkey" class="form__text" type="text"
                    ...
                    <p class="form__group">
                        <select id="groupId" class="form__select" wire:model.live="groupId"
                            x-data="{ groupId: '' }" x-model="groupId"
                    ...
                    <tbody>
                        ...
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <time datetime="{{ $user->last_action }}"
