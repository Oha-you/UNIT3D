        ...
        <div class="panel__body" style="padding: 5px">
            <form class="form">
                <div class="form__group--short-horizontal">
                    <p class="form__group">
                        <input id="torrent" wire:model.live="torrent" class="form__text"
                    ...
                    <p class="form__group">
                        <input id="user" wire:model.live="user" class="form__text"
                            type="search" autocomplete="off" placeholder=" " />
                        <label class="form__label form__label--floating"
                            for="user">Username</label>
                    </p>
                    <p class="form__group">
                        <input id="agent" wire:model.live="agent" class="form__text"
                            type="search" autocomplete="off" placeholder=" " />
                        <label class="form__label form__label--floating"
                            for="agent">Agent</label>
                    </p>
                    <p class="form__group">
                        <select id="seeder" wire:model.live="seeder" class="form__select"
                            placeholder=" ">
                    ...
                    <p class="form__group">
                        <select id="active" wire:model.live="active" class="form__select"
                            placeholder=" ">
                            <option value="any">Any</option>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th wire:click="sortBy('uploaded_sum')" role="columnheader button">
                                    ...
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.uploaded_sum',
                                    ])
                                </th>
                                <th wire:click="sortBy('actual_uploaded_sum')" role="columnheader button">
                                    {{ __('user.upload-true') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.actual_uploaded_sum',
                                    ])
                                </th>
                                <th wire:click="sortBy('client_uploaded_sum')" role="columnheader button">
                                    Client upload
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.client_uploaded_sum',
                                    ])
                                </th>
                                <th wire:click="sortBy('downloaded_sum')" role="columnheader button">
                                    {{ __('user.credited-download') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.downloaded_sum',
                                    ])
                                </th>
                                <th wire:click="sortBy('actual_downloaded_sum')" role="columnheader button">
                                    {{ __('user.download-true') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.actual_downloaded_sum',
                                    ])
                                </th>
                                <th wire:click="sortBy('client_downloaded_sum')" role="columnheader button">
                                    Client download
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.client_downloaded_sum',
                                    ])
                                </th>
                                <th wire:click="sortBy('refunded_download_sum')" role="columnheader button">
                                    {{ __('torrent.refunded') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.refunded_download_sum',
                                    ])
                                </th>
                                <th wire:click="sortBy('created_at_min')" role="columnheader button">
                                    {{ __('torrent.started') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.created_at_min',
                                    ])
                                </th>
                                <th wire:click="sortBy('updated_at_max')" role="columnheader button">
                                    Announced
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.updated_at_max',
                                    ])
                                </th>
                                <th wire:click="sortBy('seedtime_avg')" role="columnheader button">
                                    {{ __('user.avg-seedtime') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.seedtime_avg',
                                    ])
                                </th>
                                ...
                                <th wire:click="sortBy('leeching_count')" role="columnheader button">
                                    {{ __('torrent.leeching') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'leeching_count',
                                    ])
                                </th>
                                <th wire:click="sortBy('prewarn_count')" role="columnheader button"
                                    title="{{ __('torrent.prewarn') }}">
                                    <i class="fas fa-exclamation"></i>
                                </th>
                                <th wire:click="sortBy('hitrun_count')" role="columnheader button"
                                    title="{{ __('torrent.hitrun') }}">
                                    <i class="fas fa-exclamation-triangle"></i>
                                </th>
                                <th wire:click="sortBy('immune_count')" role="columnheader button"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th wire:click="sortBy('history.uploaded')" role="columnheader button">
                                    {{ __('user.credited-upload') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.uploaded',
                                    ])
                                </th>
                                <th wire:click="sortBy('history.actual_uploaded')"
                                    role="columnheader button">
                                    {{ __('user.upload-true') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.actual_uploaded',
                                    ])
                                </th>
                                <th wire:click="sortBy('history.client_uploaded')"
                                    role="columnheader button">
                                    Client upload
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.client_uploaded',
                                    ])
                                </th>
                                <th wire:click="sortBy('history.downloaded')" role="columnheader button">
                                    {{ __('user.credited-download') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.downloaded',
                                    ])
                                </th>
                                <th wire:click="sortBy('history.actual_downloaded')"
                                    role="columnheader button">
                                    {{ __('user.download-true') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.actual_downloaded',
                                    ])
                                </th>
                                <th wire:click="sortBy('history.client_downloaded')"
                                    role="columnheader button">
                                    Client download
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.client_downloaded',
                                    ])
                                </th>
                                <th wire:click="sortBy('history.refunded_download')"
                                    role="columnheader button">
                                    {{ __('torrent.refunded') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.refunded_download',
                                    ])
                                </th>
                                ...
                                <th wire:click="sortBy('history.updated_at')" role="columnheader button">
                                    Announced
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.updated_at',
                                    ])
                                </th>
                                <th wire:click="sortBy('history.completed_at')"
                                    role="columnheader button">
                                    {{ __('torrent.completed_at') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.completed_at',
                                    ])
                                </th>
                                <th wire:click="sortBy('history.prewarned_at')"
                                    role="columnheader button">
                                    {{ __('torrent.prewarn') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.prewarned_at',
                                    ])
                                </th>
                                <th wire:click="sortBy('history.seedtime')" role="columnheader button">
                                    {{ __('torrent.seedtime') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'history.seedtime',
                                    ])
                                </th>
                                ...
                                <th wire:click="sortBy('hitrun')" role="columnheader button"
                                    title="{{ __('torrent.hitrun') }}">
                                    <i class="fas fa-exclamation-triangle"></i>
                                </th>
                                <th wire:click="sortBy('immune')" role="columnheader button"
                                    title="{{ __('torrent.immune') }}">
                                    <i class="fas fa-syringe"></i>
                                </th>
                            </tr>
                        ...
                        <tbody>
                            @foreach ($histories as $history)
                                <tr>
                                    ...
                                    <td>
                                        <time datetime="{{ $history->prewarned_at }}"
