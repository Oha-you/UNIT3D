<div class="page__torrents torrent-search__component">
    <search class="compact-search torrent-search__filters" x-data="toggle">
        <div class="compact-search__visible-default">
            <p class="form__group">
                <input id="name" type="search" autocomplete="off" wire:model.live="name"
                    class="form__text" placeholder=" "
                    @if (auth()->user()->settings->torrent_search_autofocus) autofocus @endif />
        ...
        <form class="form" x-cloak x-show="isToggledOn">
            <div class="form__group--short-horizontal">
                <p class="form__group">
                    <input id="description" wire:model.live="description" class="form__text"
                        placeholder=" " />
                ...
                <p class="form__group">
                    <input id="mediainfo" wire:model.live="mediainfo" class="form__text"
                        placeholder=" " />
                ...
                <p class="form__group">
                    <input id="keywords" wire:model.live="keywords" class="form__text"
                        placeholder=" " />
                ...
                <p class="form__group">
                    <input id="uploader" wire:model.live="uploader" class="form__text"
                        placeholder=" " />
            ...
            <div class="form__group--short-horizontal">
                <div class="form__group--short-horizontal">
                    <p class="form__group" x-data="{ startYear: $wire.entangle('startYear') }">
                        <input id="startYear"
                            ...
                            "
                            x-model.live="startYear" class="form__text" inputmode="numeric"
                            minlength="4" pattern="[0-9]{4}" placeholder=" " />
                    ...
                    <p class="form__group" x-data="{ endYear: $wire.entangle('endYear') }">
                        <input id="endYear"
                            ...
                            "
                            x-model.live="endYear" class="form__text" inputmode="numeric"
                            minlength="4" pattern="[0-9]{4}" placeholder=" " />
                ...
                <div class="form__group--short-horizontal">
                    <p class="form__group">
                        <input id="episodeNumber" wire:model.live="episodeNumber" class="form__text"
                    ...
                    <p class="form__group">
                        <input id="seasonNumber" wire:model.live="seasonNumber" class="form__text"
                            inputmode="numeric" pattern="[0-9]*" placeholder=" " />
                ...
                <div class="form__group--short-horizontal">
                    <p class="form__group">
                        <input id="minSize" wire:model.live="minSize" class="form__text"
                            inputmode="numeric" pattern="[0-9]*" placeholder=" " />
                    ...
                    <p class="form__group">
                        <select id="minSizeMultiplier" wire:model.live="minSizeMultiplier"
                ...
                <div class="form__group--short-horizontal">
                    <p class="form__group">
                        <input id="maxSize" wire:model.live="maxSize" class="form__text"
                            inputmode="numeric" pattern="[0-9]*" placeholder=" " />
                    ...
                    <p class="form__group">
                        <select id="maxSizeMultiplier" wire:model.live="maxSizeMultiplier"
                            class="form__select" placeholder=" ">
                            <option value="1" selected>Bytes</option>
                            <option value="1000">KB</option>
                            <option value="1024">KiB</option>
            ...
            <div class="form__group--short-horizontal">
                ...
                <p class="form__group">
                    <select id="adult" wire:model.live="adult" class="form__select"
                        placeholder=" ">
            ...
            <div class="form__group--short-horizontal">
                <p class="form__group">
                    <input id="playlistId" wire:model.live="playlistId" class="form__text"
                        inputmode="numeric" pattern="[0-9]*" placeholder=" " />
                ...
                <p class="form__group">
                    <input id="collectionId" wire:model.live="collectionId" class="form__text"
                        inputmode="numeric" pattern="[0-9]*" placeholder=" " />
                ...
                <p class="form__group">
                    <input id="companyId" wire:model.live="companyId" class="form__text"
                        inputmode="numeric" pattern="[0-9]*" placeholder=" " />
                ...
                <p class="form__group">
                    <input id="networkId" wire:model.live="networkId" class="form__text"
                        inputmode="numeric" pattern="[0-9]*" placeholder=" " />
            ...
            <div class="form__group--short-horizontal">
                <p class="form__group">
                    <input id="tmdbId" wire:model.live="tmdbId" class="form__text"
                        inputmode="numeric" pattern="[0-9]*" placeholder=" " />
                    <label class="form__label form__label--floating" for="tmdbId">TMDb
                        ID</label>
                </p>
                <p class="form__group">
                    <input id="imdbId" wire:model.live="imdbId" class="form__text"
                        inputmode="numeric" pattern="[0-9]+|tt0*\d{7,}" placeholder=" " />
                    <label class="form__label form__label--floating" for="imdbId">IMDb
                        ID</label>
                </p>
                <p class="form__group">
                    <input id="tvdbId" wire:model.live="tvdbId" class="form__text"
                        inputmode="numeric" pattern="[0-9]*" placeholder=" " />
                    <label class="form__label form__label--floating" for="tvdbId">TVDb
                        ID</label>
                </p>
                <p class="form__group">
                    <input id="malId" wire:model.live="malId" class="form__text"
                        inputmode="numeric" pattern="[0-9]*" placeholder=" " />
                ...
                <div class="form__group">
                    <fieldset class="form__fieldset">
                        ...
                        <div class="form__fieldset-checkbox-container">
                            <p class="form__group">
                                <label class="form__label">
                                    <input class="form__checkbox" type="checkbox" value="0"
                            ...
                            <p class="form__group">
                                <label class="form__label">
                                    <input class="form__checkbox" type="checkbox" value="25"
                                        wire:model.live="free" />
                                    25% Freeleech
                                </label>
                            </p>
                            <p class="form__group">
                                <label class="form__label">
                                    <input class="form__checkbox" type="checkbox" value="50"
                                        wire:model.live="free" />
                                    50% Freeleech
                                </label>
                            </p>
                            <p class="form__group">
                                <label class="form__label">
                                    <input class="form__checkbox" type="checkbox" value="75"
                                        wire:model.live="free" />
                                    75% Freeleech
                                </label>
                            </p>
                            <p class="form__group">
                                <label class="form__label">
                                    <input class="form__checkbox" type="checkbox" value="100"
                                        wire:model.live="free" />
                                    100% Freeleech
                                </label>
                            </p>
    ...
    <section class="panelV2 torrent-search__results">
        <header class="panel__header">
            ...
            <div class="panel__actions">
                ...
                <div class="panel__action">
                    <div class="form__group">
                        <select id="view" class="form__select" wire:model.live="view"
                            required>
                        ...
                        <label class="form__label form__label--floating"
                            for="view">Layout</label>
                    </div>
                </div>
                <div class="panel__action">
                    <div class="form__group">
                        <select id="perPage" class="form__select" wire:model.live="perPage"
                            required>
                    ...
                    <table class="data-table">
                        <thead>
                            <tr @class([
                                ...
                                <th class="torrent-search--list__name-header" wire:click="sortBy('name')"
                                ...
                                <th class="torrent-search--list__ratings-header"
                                    wire:click="sortBy('rating')" role="columnheader button">
                                    Rating
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'rating',
                                    ])
                                </th>
                                <th class="torrent-search--list__size-header" wire:click="sortBy('size')"
                                    role="columnheader button">
                                    {{ __('torrent.size') }}
                                    @include('livewire.includes._sort-icon', [
                                        'field' => 'size',
                                ...
                                <th class="torrent-search--list__seeders-header"
                                    wire:click="sortBy('seeders')" role="columnheader button"
                                ...
                                <th class="torrent-search--list__leechers-header"
                                ...
                                <th class="torrent-search--list__completed-header"
                                ...
                                <th class="torrent-search--list__age-header"
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <th class="torrent-search--list__age-header" wire:click="sortBy('created_at')"
                                role="columnheader button">
                ...
                @case($view === 'poster')
                    ...
                    <div class="panel__body torrent-search--poster__results">
                        @forelse ($torrents as $group)
                            @switch($group->meta)
                                @case('movie')
                                    <x-movie.poster :categoryId="$group->category_id" :movie="$group->movie" :tmdb="$group->tmdb_movie_id" />
                                @break

                                @case('tv')
                                    <x-tv.poster :categoryId="$group->category_id" :tv="$group->tv" :tmdb="$group->tmdb_tv_id" />
                                @break
                            @endswitch
                            @empty
                                {{ __('common.no-result') }}
