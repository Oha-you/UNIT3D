            ...
            <thead>
                <tr>
                    ...
                    <th wire:click="sortBy('torrents.info_hash')" role="columnheader button">
                        ...
                        @include('livewire.includes._sort-icon', [
                            'field' => 'torrents.info_hash',
                        ])
                    </th>
                    <th wire:click="sortBy('torrents.deleted_at')" role="columnheader button">
                        {{ __('common.deleted_at') }}
                        @include('livewire.includes._sort-icon', [
                            'field' => 'torrents.deleted_at',
                        ])
                    </th>
                    <th wire:click="sortBy('unregistered_info_hashes.updated_at')"
                        role="columnheader button">
                        {{ __('torrent.updated_at') }}
                        @include('livewire.includes._sort-icon', [
                            'field' => 'unregistered_info_hashes.updated_at',
                        ])
                    </th>
                </tr>
            </thead>
            <tbody>
                @foreach ($unregisteredInfoHashes as $unregisteredInfoHash)
                    <tr>
                        ...
                        <td>
                            <time datetime="{{ $unregisteredInfoHash->deleted_at }}"
