    ...
    <section class="panelV2">
        ...
        <div class="panel__body">
            <form class="form" method="POST"
                ...
                @method('PATCH')
                <p class="form__group">
                    <input id="name" class="form__text" name="name" placeholder=" "
                ...
                <p class="form__group">
                    <input id="position" class="form__text" inputmode="numeric" name="position"
                        pattern="[0-9]*" placeholder=" " type="text" value="{{ $bot->position }}" />
                    <label class="form__label form__label--floating" for="position">
                        {{ __('common.position') }}
                    </label>
                </p>
                <p class="form__group">
                    <input id="command" class="form__text" name="command" placeholder=" "
                        type="text" value="{{ $bot->command }}" />
                    <label class="form__label form__label--floating" for="command">
                        {{ __('bot.command') }}
                    </label>
                </p>
                <p class="form__group">
                    <input id="emoji" class="form__text" name="emoji" placeholder=" "
                        type="text" value="{{ $bot->emoji }}" />
                    <label class="form__label form__label--floating" for="emoji">
                        {{ __('bot.emoji-code') }}
                    </label>
                </p>
                <p class="form__group">
                    <input id="icon" class="form__text" name="icon" placeholder=" "
                        type="text" value="{{ $bot->icon }}" />
                    <label class="form__label form__label--floating" for="icon">
                        {{ __('bot.icon') }}
                    </label>
                </p>
                <p class="form__group">
                    <input id="color" class="form__text" name="color" placeholder=" "
                        type="text" value="{{ $bot->color }}" />
