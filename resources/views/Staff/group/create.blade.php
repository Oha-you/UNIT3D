            ...
            <form class="form" method="POST" action="{{ route('staff.groups.store') }}">
                ...
                <p class="form__group">
                    <input id="effect" class="form__text" type="text" name="group[effect]"
                        value="none" placeholder="GIF effect" />
                ...
                <p class="form__group">
                    ...
                    <input id="autogroup" class="form__checkbox" name="group[autogroup]"
                        type="checkbox" x-model="autogroup" value="1" />
                ...
                <p class="form__group" x-show="autogroup" x-cloak>
                    <input id="min_ratio" class="form__text" type="text" name="group[min_ratio]"
                        placeholder=" " />
                ...
                <p class="form__group" x-show="autogroup" x-cloak>
                    <input id="min_age" class="form__text" type="text" name="group[min_age]"
                        placeholder=" " />
