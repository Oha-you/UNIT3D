    ...
    <section class="panelV2">
        ...
        <div class="panel__body">
            <form class="form" method="POST"
                ...
                @method('PATCH')
                <p class="form__group">
                    <input id="username" class="form__text" name="username" placeholder=" " required
                ...
                <p class="form__group">
                    <input id="uploaded" class="form__text" inputmode="numeric" name="uploaded"
                        pattern="[0-9]{1,}" placeholder=" " required type="text"
                        value="{{ $user->uploaded }}" />
                ...
                <p class="form__group">
                    <input id="downloaded" class="form__text" inputmode="numeric" name="downloaded"
                        pattern="[0-9]{1,}" placeholder=" " required type="text"
                ...
                <p class="form__group">
                    <input id="title" class="form__text" name="title" placeholder=" "
                ...
                <p class="form__group">
                    <input id="seedbonus" class="form__text" inputmode="numeric" name="seedbonus"
                        pattern="[0-9]{1,}(?:.[0-9]{1,2})?" placeholder=" " required type="text"
                ...
                <p class="form__group">
                    <input id="fl_tokens" class="form__text" inputmode="numeric" name="fl_tokens"
                        pattern="[0-9]{1,}" placeholder=" " required type="text"
                ...
                <p class="form__group">
                    <input id="invites" class="form__text" inputmode="numeric" name="invites"
                        pattern="[0-9]{1,}" placeholder=" " required type="text"
                        value="{{ $user->invites }}" />
        ...
        <div class="panel__body">
            <form class="form" method="POST"
                ...
                <p class="form__group">
                    ...
                    <input id="override_can_chat" class="form__checkbox" type="checkbox"
                        x-bind:checked="override_can_chat" x-model="override_can_chat" />
                    <label for="override_can_chat">Override group can chat</label>
                </p>
                <div class="form__group" x-show="override_can_chat" x-cloak>
                    <fieldset class="form__fieldset">
                        <input type="hidden" name="can_chat"
                            x-bind:value="override_can_chat ? '0' : ''" />
                        <input type="checkbox" class="form__checkbox" id="can_chat" name="can_chat"
                            value="1" x-bind:checked="override_can_chat && $el.checked"
                ...
                <p class="form__group">
                    ...
                    <input id="override_can_comment" class="form__checkbox" type="checkbox"
                        x-bind:checked="override_can_comment" x-model="override_can_comment" />
                    <label for="override_can_comment">Override group can comment</label>
                </p>
                <div class="form__group" x-show="override_can_comment" x-cloak>
                    <fieldset class="form__fieldset">
                        <input type="hidden" name="can_comment"
                            x-bind:value="override_can_comment ? '0' : ''" />
                        <input type="checkbox" class="form__checkbox" id="can_comment"
                ...
                <p class="form__group">
                    <input id="override_can_invite" class="form__checkbox" type="checkbox"
                        x-bind:checked="override_can_invite" x-model="override_can_invite" />
                    <label for="override_can_invite">Override group can invite</label>
                </p>
                <div class="form__group" x-show="override_can_invite" x-cloak>
                    <fieldset class="form__fieldset">
                        <input type="hidden" name="can_invite"
                            x-bind:value="override_can_invite ? '0' : ''" />
                        <input type="checkbox" class="form__checkbox" id="can_invite"
                            name="can_invite" value="1"
                ...
                <p class="form__group">
                    <input id="override_can_request" class="form__checkbox" type="checkbox"
                        x-bind:checked="override_can_request" x-model="override_can_request" />
                    <label for="override_can_request">Override group can request</label>
                </p>
                <div class="form__group" x-show="override_can_request" x-cloak>
                    <fieldset class="form__fieldset">
                        <input type="hidden" name="can_request"
                            x-bind:value="override_can_request ? '0' : ''" />
                        <input type="checkbox" class="form__checkbox" id="can_request"
                            name="can_request" value="1"
                ...
                <p class="form__group">
                    <input id="override_can_upload" class="form__checkbox" type="checkbox"
                        x-bind:checked="override_can_upload" x-model="override_can_upload" />
                    <label for="override_can_upload">Override group can upload</label>
                </p>
                <div class="form__group" x-show="override_can_upload" x-cloak>
                    <fieldset class="form__fieldset">
                        <input type="hidden" name="can_upload"
                            x-bind:value="override_can_upload ? '0' : ''" />
                        <input type="checkbox" class="form__checkbox" id="can_upload"
                            name="can_upload" value="1"
                ...
                <p class="form__group">
                    ...
                    <input type="checkbox" class="form__checkbox" id="is_donor" name="is_donor"
                        value="1" @checked($user->is_donor) />
                    <label for="is_donor">Active donor?</label>
                </p>
                <p class="form__group">
                    <input type="hidden" name="is_lifetime" value="0" />
                    <input type="checkbox" class="form__checkbox" id="is_lifetime"
                        name="is_lifetime" value="1" @checked($user->is_lifetime) />
