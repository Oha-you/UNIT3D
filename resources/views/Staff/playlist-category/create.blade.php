...
@section('main')
    <section class="panelV2">
        ...
        <div class="panel__body">
            <form class="form" method="POST" action="{{ route('staff.playlist_categories.store') }}"
                ...
                <p class="form__group">
                    <textarea id="description" name="description" class="form__textarea" placeholder=" "></textarea>
