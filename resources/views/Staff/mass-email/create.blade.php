...
@section('meta')
    <meta name="description" content="{{ __('staff.mass-email') }} - {{ __('staff.staff-dashboard') }}" />
@endsection
...
@section('main')
    <section class="panelV2">
        ...
        <div class="panel__body">
            <form class="form" action="{{ route('staff.mass_email.store') }}" method="POST"
                x-data="confirmation">
                @csrf
                ...
                <p class="form__group">
                    <input id="subject" class="form__text" minlength="5" name="subject"
                        type="text" required />
                ...
                <p class="form__group">
                    <button x-on:click.prevent="confirmAction" class="form__button form__button--filled"
