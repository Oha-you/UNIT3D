        ...
        <section class="auth-form">
            ...
            <form class="auth-form__form" method="POST" action="{{ route('two-factor.login') }}">
                ...
                <p class="auth-form__text-input-group" x-show="tab === 'totp'">
                    ...
                    <input id="code" class="auth-form__text-input" autocomplete="one-time-code"
                        autofocus inputmode="numeric" name="code" autocapitalize="off"
                        autocorrect="off" spellcheck="false" type="tel"
                        value="{{ old('code') }}" x-bind="totpCode" />
                </p>
                <p class="auth-form__text-input-group" x-cloak x-show="tab === 'recovery'">
                    <label class="auth-form__label" for="recovery_code">
                        {{ __('Use a recovery code') }}
                    </label>
                    <input id="recovery_code" class="auth-form__text-input" autocomplete="off"
                        name="recovery_code" autocapitalize="off" autocorrect="off"
                        spellcheck="false" type="text" x-bind="recoveryCode" />
                </p>
