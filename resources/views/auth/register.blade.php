    ...
    <main>
        <section class="auth-form">
            <form class="auth-form__form" method="POST"
                ...
                @if (
                    (config('other.invite-only') && !request()->has('code')) ||
                        Session::has('warning') ||
                        Session::has('success') ||
                        Session::has('info'))
                ...
                @else
                    <p class="auth-form__text-input-group">
                        ...
                        <input id="username" class="auth-form__text-input" autofocus
                    ...
                    <p class="auth-form__text-input-group">
                        ...
                        <input id="email" class="auth-form__text-input" name="email" required
                    ...
                    <p class="auth-form__text-input-group">
                        ...
                        <input id="password" class="auth-form__text-input"
                    ...
                    <p class="auth-form__text-input-group">
                        ...
                        <input id="password_confirmation" class="auth-form__text-input"
