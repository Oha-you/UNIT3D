            ...
            <form class="auth-form__form" method="POST" action="{{ route('application.store') }}">
                ...
                @if (config('other.application_signups'))
                    ...
                    <p class="auth-form__select-group">
                        ...
                        <select id="type" class="auth-form__select" name="application[type]"
                            required>
                            <option class="auth-form__option" value="New to the game" selected>
                                {{ __('auth.newbie') }}
                            </option>
                            <option class="auth-form__option"
                    ...
                    <p class="auth-form__text-input-group">
                        ...
                        <input id="email" type="email" class="auth-form__text-input"
                            name="application[email]" required />
                    </p>
                    <p class="auth-form__textarea-group">
                        ...
                        <textarea id="referrer" type="referrer" class="auth-form__textarea" name="application[referrer]"
                            required></textarea>
                    </p>
                    ...
                    <template x-for="proof in proofs">
                        <fieldset class="auth-form__fieldset">
                            ...
                            <p class="auth-form__text-input-group">
                                ...
                                <input x-bind:id="'profile' + (proof - 1)"
                                    class="auth-form__text-input"
                                    x-bind:name="'links[' + (proof - 1) + '][url]'" type="url"
                                    placeholder=" " />
                            </p>
                        </fieldset>
                    </template>
                    <p class="auth-form__button-container">
                        <button x-on:click.prevent="proofs++" class="auth-form__button--text"
                            type="button">
                            {{ __('common.add') }}
                        </button>
                        <button class="auth-form__button--text"
