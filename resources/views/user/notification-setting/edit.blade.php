        ...
        <div class="panel__body">
            <form class="form" method="POST"
                ...
                <fieldset class="form__fieldset">
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_account_follow"
                                value="1" @checked($user->notification === null || $user->notification?->show_account_follow) />
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_account_unfollow"
                                value="1" @checked($user->notification === null || $user->notification?->show_account_unfollow) />
                ...
                <fieldset class="form__fieldset">
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_bon_gift"
                                value="1" @checked($user->notification === null || $user->notification?->show_bon_gift) />
                ...
                <fieldset class="form__fieldset">
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_following_upload"
                                value="1" @checked($user->notification === null || $user->notification?->show_following_upload) />
                ...
                <fieldset class="form__fieldset">
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_forum_topic"
                                value="1" @checked($user->notification === null || $user->notification?->show_forum_topic) />
                ...
                <fieldset class="form__fieldset">
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_request_fill"
                                value="1" @checked($user->notification === null || $user->notification?->show_request_fill) />
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox"
                                name="show_request_fill_approve" value="1"
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox"
                                name="show_request_fill_reject" value="1"
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_request_claim"
                                value="1" @checked($user->notification === null || $user->notification?->show_request_claim) />
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_request_unclaim"
                                value="1" @checked($user->notification === null || $user->notification?->show_request_unclaim) />
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_request_comment"
                                value="1" @checked($user->notification === null || $user->notification?->show_request_comment) />
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_request_bounty"
                                value="1" @checked($user->notification === null || $user->notification?->show_request_bounty) />
                ...
                <fieldset class="form__fieldset">
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox"
                                name="show_subscription_topic" value="1"
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox"
                                name="show_subscription_forum" value="1"
                ...
                <fieldset class="form__fieldset">
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_torrent_comment"
                                value="1" @checked($user->notification === null || $user->notification?->show_torrent_comment) />
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_torrent_thank"
                                value="1" @checked($user->notification === null || $user->notification?->show_torrent_thank) />
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox" name="show_torrent_tip"
                                value="1" @checked($user->notification === null || $user->notification?->show_torrent_tip) />
                ...
                <fieldset class="form__fieldset">
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            <input type="hidden" name="show_mention_article_comment"
                                value="0" />
                            <input class="form__checkbox" type="checkbox"
                                name="show_mention_article_comment" value="1"
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            <input type="hidden" name="show_mention_request_comment"
                                value="0" />
                            <input class="form__checkbox" type="checkbox"
                                name="show_mention_request_comment" value="1"
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            <input type="hidden" name="show_mention_torrent_comment"
                                value="0" />
                            <input class="form__checkbox" type="checkbox"
                                name="show_mention_torrent_comment" value="1"
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            <input class="form__checkbox" type="checkbox"
                                name="show_mention_forum_post" value="1"
                            ...
                            <tbody x-ref="tbody">
                                @foreach ($groups as $group)
                                    <tr>
                                        ...
                                        @foreach (['json_account_groups', 'json_bon_groups', 'json_following_groups', 'json_forum_groups', 'json_request_groups', 'json_subscription_groups', 'json_torrent_groups', 'json_mention_groups'] as $setting)
                                            <td x-bind="cell">
                                                <input class="form__checkbox" type="checkbox"
                                                    name="{{ $setting }}[]"
                                                    value="{{ $group->id }}"
                ...
                <p class="form__group">
                    <label class="form__label">
                        ...
                        <input class="form__checkbox" type="checkbox" value="1"
                            name="block_notifications" @checked($user->notification?->block_notifications) />
