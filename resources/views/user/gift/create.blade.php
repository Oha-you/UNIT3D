...
@section('main')
    <section class="panelV2">
        ...
        <div class="panel__body">
            <form id="send_bonus" class="form" method="POST"
                action="{{ route('users.gifts.store', ['user' => $user]) }}">
                @csrf
                <p class="form__group">
                    <input id="recipient_username" class="form__text" name="recipient_username"
                ...
                <p class="form__group">
                    <input id="bon" class="form__text" inputmode="numeric" name="bon"
                        pattern="[0-9]*" placeholder=" " required type="text" />
