    ...
    <div class="footer__sub-footer">
        <p class="footer__icons">
            ...
            <a href="https://livewire.laravel.com" target="_blank">
                <svg height="22" viewBox="0 0 40 30" fill="none"
            ...
            <a href="https://rust-lang.org" target="_blank">
                <svg height="22" viewBox="0 0 106 106" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="logo" transform="translate(53, 53)">
                        <path id="r" transform="translate(0.5, 0.5)" stroke="black"
                        ...
                        <g id="gear" mask="url(#holes)">
                            ...
                            <g id="cogs">
                                <polygon id="cog" stroke="black" stroke-width="3"
                                    stroke-linejoin="round" points="46,3 51,0 46,-3" />
                            ...
                            <g id="mounts">
                                <polygon id="mount" stroke="black" stroke-width="6"
                                    stroke-linejoin="round" points="-7,-42 0,-35 7,-42" />
